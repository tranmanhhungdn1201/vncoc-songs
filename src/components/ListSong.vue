      ...
      <div class="relative">
          <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            ...
            <div class="relative w-full">
                ...
                <input v-model="textSearch" @keyup="searchSong(textSearch)" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Tìm kiếm tên, mã, nội dung của bài hát">
                <button type="button" class="absolute inset-y-0 end-0 flex items-center pe-3" v-show="textSearch.length > 0">
                    <svg @click="clearSearch()" class="w-4 h-4 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white fill-gray-500" version="1.1" viewBox="0 0 512 512" width="512px" fill="none">
